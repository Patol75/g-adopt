    ...
    **Note**:
    ...
    def __init__(
        ...
        **irksome_kwargs,
        ...
        self.stepper = TimeStepper(
            F, butcher_tableau, t, dt, solution, **stepper_kwargs
        )
    ...
    def advance(self) -> tuple[float, float] | None:
        ...
        **Note**:
            ...
            t.assign(t + dt)  # t and dt are generated by the user via `time_objects`
        ...
        # Advance time integration and return adaptive diagnostics if present
